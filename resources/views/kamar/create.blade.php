...
@section('content')
    <div class="section-header">
        ...
        <a href="{{ route('kamar.index') }}" class="btn btn-ghost"><i data-lucide="arrow-left"
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="nomor_kamar" name="nomor_kamar"
                        class="form-control {{ $errors->has('nomor_kamar') ? 'invalid' : '' }}"
                        value="{{ old('nomor_kamar') }}" placeholder="A-001">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama_kamar" name="nama_kamar" class="form-control"
                        value="{{ old('nama_kamar') }}" placeholder="Kamar Lantai ...">
                </div>
                <div class="form-group">
                    <label for="tipe">Tipe Kamar <span style="color:var(--red)">*</span></label>
                    <input type="text" id="tipe" name="tipe"
                        class="form-control {{ $errors->has('tipe') ? 'invalid' : '' }}" value="{{ old('tipe') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="harga_per_malam" name="harga_per_malam"
                        class="form-control {{ $errors->has('harga_per_malam') ? 'invalid' : '' }}"
                        value="{{ old('harga_per_malam') }}" placeholder="150000" min="0">
                    @error('harga_per_malam') <span class="form-error">{{ $message }}</span> @enderror
                </div>
                <div class="form-group full">
                    <label for="deskripsi">Deskripsi</label>
                    <textarea id="deskripsi" name="deskripsi" class="form-control"
                        placeholder="Deskripsi fasilitas kamar...">{{ old('deskripsi') }}</textarea>
                </div>
            </div>
